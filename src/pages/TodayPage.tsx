...
import { getFoodEntriesForDate, getCheckinForDate, deleteFoodEntry } from '../store'
...
export function TodayPage() {
  ...
  const foods = useMemo(() => getFoodEntriesForDate(date), [date, tick])
  const checkin = useMemo(() => getCheckinForDate(date), [date, tick])
